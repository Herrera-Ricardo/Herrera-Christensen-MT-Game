...
public class Game implements Serializable{
    ...
    public int hashCode() {
        int hash = 3;
        hash = 73 * hash + (int) (Double.doubleToLongBits(this.dayOnTrail) ^ (Double.doubleToLongBits(this.dayOnTrail) >>> 32));
        hash = 73 * hash + (int) (Double.doubleToLongBits(this.pace) ^ (Double.doubleToLongBits(this.pace) >>> 32));
        hash = 73 * hash + (int) (Double.doubleToLongBits(this.milesTraveled) ^ (Double.doubleToLongBits(this.milesTraveled) >>> 32));
        hash = 73 * hash + (int) (Double.doubleToLongBits(this.currentMoneyBalance) ^ (Double.doubleToLongBits(this.currentMoneyBalance) >>> 32));
        return hash;
    }
